...
public class ControllerConfig {
    ...
    public void init() {
        ...
        this.packageName = "com.mmtap.wk.modular." + contextConfig.getModuleName() + ".controller";
        this.controllerPathTemplate = "\\src\\main\\java\\com\\mmtap\\wk\\modular\\" + contextConfig.getModuleName() + "\\controller\\{}Controller.java";
    }
