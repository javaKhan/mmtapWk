...
public class WkApplication extends WebMvcConfigurerAdapter{

    protected final static Logger logger = LoggerFactory.getLogger(WkApplication.class);

    @Autowired
    WkProperties wkProperties;
